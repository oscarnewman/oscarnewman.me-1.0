...
export const meta = {
  ...
  author: 'Oscar Newman',
  description:
    "Four months since adopting Remix in production at Solv Health: HMR, image optimization, and community make Next great for static sites. Remix's mutations make it a no-brainer for everything else.",
  published: true,
  slug: 'remix-vs-next',
}
