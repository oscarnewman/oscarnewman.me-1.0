...
export const meta = {
  title:
    'Safely share secrets and environment variables with your team using OpenSSL',
  date: '2022-11-23',
  description:
    'Two small NPM scripts make it dead-simple to share secrets and environment variables with your team.',
}
